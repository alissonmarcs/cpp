...
TEST (FormTest, NormalSigning)
{
  ...
  EXPECT_TRUE (form.isSigned ()); // Assuming there is a public method
                                  // isSigned() to check _isSigned
}
...
TEST (BureaucratTest, SignFormNormalCase)
{
  ...
  Form form (1, 1, "TestForm"); // Assuming Form constructor takes name, sign
                                // grade, and execute grade
