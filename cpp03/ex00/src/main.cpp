...
main (void)
{

  {
    ...
    print (std::left << std::setw (18)
                     << "Hit points: " << tmp.getHitPoints ());
    print (std::left << std::setw (18)
                     << "Energy points: " << tmp.getEnergyPoints ());
    print (std::left << std::setw (18)
...

  {
    ...
    print (std::left << std::setw (32) << "Energy points at creation: "
                     << tmp.getEnergyPoints ());
    tmp.attack ("carla");
    print (std::left << std::setw (32) << "Energy points after attack: "
                     << tmp.getEnergyPoints ());
    print (std::left << std::setw (32)
                     << "Hit points before repair: " << tmp.getHitPoints ());
    tmp.beRepaired (1);
    print (std::left << std::setw (32) << "Energy  points after repair: "
                     << tmp.getEnergyPoints ());
    print (std::left << std::setw (32)
                     << "Hit points after repair: " << tmp.getHitPoints ());
  }
